...
private List<ModelCommand> haveCommandPrototypes()
   ...
   public M2Editor setCommandPrototypes(List<ModelCommand> value)
   {
   ...
   public M2Editor setActiveCommands(Map<String, ModelCommand> value)
   {
   ...
   public M2Editor setCommandListeners(Map<String, List<CommandStream>> value)
   {
   ...
   public M2Editor setMapOfFrames(Map<String, Object> value)
   {
   ...
   public M2Editor setMapOfModelObjects(Map<String, Object> value)
   {
   ...
   public M2Editor setMapOfParsedObjects(Map<String, Object> value)
   {
