...
public class BPMNService 
{
   ...
   public BPMNService setMyPort(int value)
   {
   ...
   public BPMNService setReflectorMap(ReflectorMap value)
   {
   ...
   public BPMNService setCurrentSession(String value)
   {
   ...
   public BPMNService setExecutor(ExecutorService  value)
   {
   ...
   public BPMNService setSpark(Service value)
   {
      if (value != this.spark)
      {
   ...
   private LinkedHashMap<String, BPMNApp> sessionToAppMap = new LinkedHashMap();

   public LinkedHashMap<String, BPMNApp> getSessionToAppMap()
   {
      return sessionToAppMap;
   }

   public BPMNService setSessionToAppMap(LinkedHashMap<String, BPMNApp> value)
   {
      if (value != this.sessionToAppMap)
      {
         LinkedHashMap<String, BPMNApp> oldValue = this.sessionToAppMap;
   ...
   private BPMNEditor modelEditor = null;
   ...
   public BPMNService setModelEditor(BPMNEditor value)
   {
   ...
   public BPMNService withStreams(Object... value)
   {
