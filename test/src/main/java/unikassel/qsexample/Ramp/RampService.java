...
public class RampService  
{
   ...
   public RampService setMyPort(int value)
   {
   ...
   public RampService setModelEditor(RampEditor value)
   {
   ...
   public RampService setReflectorMap(ReflectorMap value)
   {
   ...
   public RampService setCurrentSession(String value)
   {
   ...
   public RampService setExecutor(ExecutorService  value)
   {
   ...
   private LinkedHashMap<String, RampApp> sessionToAppMap = new LinkedHashMap();

   public LinkedHashMap<String, RampApp> getSessionToAppMap()
   {
      return sessionToAppMap;
   }

   public RampService setSessionToAppMap(LinkedHashMap<String, RampApp> value)
   {
      if (value != this.sessionToAppMap)
      {
         LinkedHashMap<String, RampApp> oldValue = this.sessionToAppMap;
   ...
   public RampService withStreams(Object... value)
   {
   ...
   public RampService withoutStreams(Object... value)
   {
   ...
   public void start() { 
      ...
      get("/Ramp", (req, res) -> executor.submit( () -> this.getFirstRoot(req, res)).get());
      post("/cmd", (req, res) -> executor.submit( () -> this.cmd(req, res)).get());
      post("/Rampcmd", (req, res) -> executor.submit( () -> this.cmd(req, res)).get());
      // no streams
