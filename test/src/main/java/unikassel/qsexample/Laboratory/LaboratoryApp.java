...
public class LaboratoryApp  
{
   ...
   private LaboratoryEditor modelEditor;
   ...
   public LaboratoryApp setModelEditor(LaboratoryEditor value)
   {
   ...
   public LaboratoryApp setId(String value)
   {
   ...
   public LaboratoryApp setDescription(String value)
   {
   ...
   public LaboratoryApp setContent(Page value)
   {
   ...
   public LaboratoryApp init(LaboratoryEditor editor) { 
      this.modelEditor = editor;
      this.setId("root");
      this.setDescription("Laboratory App");
      return this;
   }
