...
public class StorageApp  
{
   ...
   public StorageApp setModelEditor(StorageEditor value)
   {
   ...
   public StorageApp setId(String value)
   {
   ...
   public StorageApp setDescription(String value)
   {
   ...
   public StorageApp setContent(Page value)
   {
   ...
   public StorageApp init(StorageEditor editor) { 
