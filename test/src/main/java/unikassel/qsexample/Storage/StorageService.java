...
public class StorageService  
{
   ...
   public StorageService setMyPort(int value)
   {
   ...
   public StorageService setReflectorMap(ReflectorMap value)
   {
   ...
   public StorageService setCurrentSession(String value)
   {
   ...
   public StorageService setExecutor(ExecutorService  value)
   {
   ...
   private LinkedHashMap<String, StorageApp> sessionToAppMap = new LinkedHashMap();

   public LinkedHashMap<String, StorageApp> getSessionToAppMap()
   {
      return sessionToAppMap;
   }

   public StorageService setSessionToAppMap(LinkedHashMap<String, StorageApp> value)
   {
      if (value != this.sessionToAppMap)
      {
         LinkedHashMap<String, StorageApp> oldValue = this.sessionToAppMap;
   ...
   public StorageService withStreams(Object... value)
   {
   ...
   public StorageService withoutStreams(Object... value)
   {
   ...
   public void start() { 
      ...
      get("/Storage", (req, res) -> executor.submit( () -> this.getFirstRoot(req, res)).get());
      post("/cmd", (req, res) -> executor.submit( () -> this.cmd(req, res)).get());
      post("/Storagecmd", (req, res) -> executor.submit( () -> this.cmd(req, res)).get());
      // no streams
