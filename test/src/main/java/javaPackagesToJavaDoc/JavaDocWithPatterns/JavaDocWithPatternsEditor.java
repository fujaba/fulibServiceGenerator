...
public class JavaDocWithPatternsEditor
{
   ...
   {
      Map<String, Object> map = Yaml.forPackage("javaPackagesToJavaDoc.JavaDocWithPatterns").decode(yamlString);
...
private List<ModelCommand> haveCommandPrototypes()
   ...
   public JavaDocWithPatternsEditor setActiveCommands(Map<String, ModelCommand> value)
   {
   ...
   public JavaDocWithPatternsEditor setCommandListeners(Map<String, List<CommandStream>> value)
   {
   ...
   public JavaDocWithPatternsEditor setMapOfFrames(Map<String, Object> value)
   {
   ...
   public JavaDocWithPatternsEditor setMapOfModelObjects(Map<String, Object> value)
   {
   ...
   public JavaDocWithPatternsEditor setMapOfParsedObjects(Map<String, Object> value)
   {
