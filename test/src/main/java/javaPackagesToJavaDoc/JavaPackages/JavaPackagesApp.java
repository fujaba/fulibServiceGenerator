...
public class JavaPackagesApp
{
   ...
   public JavaPackagesApp setContent(Page value)
   {
   ...
   public JavaPackagesApp init(JavaPackagesEditor editor)
   {
   ...
   public JavaPackagesApp setModelEditor(JavaPackagesEditor value)
   {
   ...
   public JavaPackagesApp setId(String value)
   {
   ...
   public JavaPackagesApp setDescription(String value)
   {
