...
public class JavaPackagesService
{
   ...
   private JavaPackagesEditor modelEditor;
   ...
   public JavaPackagesEditor getModelEditor()
   {
      return this.modelEditor;
   }

   public JavaPackagesService setModelEditor(JavaPackagesEditor value)
   {
      ...
      final JavaPackagesEditor oldValue = this.modelEditor;
   ...
   public JavaPackagesService withStreams(Object... value)
   {
   ...
   public JavaPackagesService withoutStreams(Object... value)
   {
...
public JavaPackagesService withStreams(CommandStream value)
   {
      if (this.streams == null)
      {
...
public JavaPackagesService withStreams(Collection<? extends CommandStream> value)
   {
      for (final CommandStream item : value)
      {
         this.withStreams(item);
...
public JavaPackagesService withoutStreams(CommandStream value)
   {
...
public JavaPackagesService withoutStreams(Collection<? extends CommandStream> value)
   {
      for (final CommandStream item : value)
      {
         this.withoutStreams(item);
   ...
   public JavaPackagesService setMyPort(int value)
   {
   ...
   public JavaPackagesService setReflectorMap(ReflectorMap value)
   {
   ...
   public JavaPackagesService setCurrentSession(String value)
   {
   ...
   public JavaPackagesService setSpark(Service value)
   {
