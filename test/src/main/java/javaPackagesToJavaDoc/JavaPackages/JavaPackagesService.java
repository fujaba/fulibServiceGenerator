...
public class JavaPackagesService  
{
   ...
   private JavaPackagesEditor modelEditor = null;
   ...
   public JavaPackagesService setModelEditor(JavaPackagesEditor value)
   {
      ...
      {
         JavaPackagesEditor oldValue = this.modelEditor;
   ...
   public JavaPackagesService setSessionToAppMap(LinkedHashMap<String,JavaPackagesApp> value)
   {
      ...
      {
         LinkedHashMap<String,JavaPackagesApp> oldValue = this.sessionToAppMap;
