...
private List<ModelCommand> haveCommandPrototypes()
   ...
   public JavaPackagesEditor setMapOfParsedObjects(java.util.Map<String, Object> value)
   {
   ...
   public JavaPackagesEditor setCommandListeners(java.util.Map<String, List<CommandStream>> value)
   {
