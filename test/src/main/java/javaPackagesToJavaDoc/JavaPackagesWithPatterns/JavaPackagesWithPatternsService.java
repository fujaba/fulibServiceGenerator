...
public class JavaPackagesWithPatternsService  
{
   ...
   public JavaPackagesWithPatternsService withStreams(Object... value)
   {
   ...
   public JavaPackagesWithPatternsService withoutStreams(Object... value)
   {
   ...
   public void start() { 
      ...
      java.util.logging.Logger.getGlobal().info("JavaPackagesWithPatterns Service is listening on port " + myPort);
   }
