...
public class Page
{
   ...
   private JavaPackagesWithPatternsApp app;
   ...
   public JavaPackagesWithPatternsApp getApp()
   {
      return this.app;
   }

   public Page setApp(JavaPackagesWithPatternsApp value)
   {
      if (this.app == value)
      {
         return this;
      ...
      final JavaPackagesWithPatternsApp oldValue = this.app;
      if (this.app != null)
      {
         this.app = null;
