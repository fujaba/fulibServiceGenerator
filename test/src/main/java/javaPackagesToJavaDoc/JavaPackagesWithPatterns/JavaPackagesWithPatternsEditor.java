...
private List<ModelCommand> haveCommandPrototypes()
   ...
   public JavaPackagesWithPatternsEditor setMapOfParsedObjects(java.util.Map<String, Object> value)
   {
   ...
   public JavaPackagesWithPatternsEditor setCommandListeners(java.util.Map<String, List<CommandStream>> value)
   {
