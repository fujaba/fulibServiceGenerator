...
public class JavaPackagesWithPatternsEditor
{
   ...
   public JavaPackagesWithPatternsEditor setService(JavaPackagesWithPatternsService value)
   {
      ...
      final JavaPackagesWithPatternsService oldValue = this.service;
   ...
   {
      Map<String, Object> map = Yaml.forPackage("javaPackagesToJavaDoc.JavaPackagesWithPatterns").decode(yamlString);
...
private List<ModelCommand> haveCommandPrototypes()
   ...
   public JavaPackagesWithPatternsEditor setCommandPrototypes(List<ModelCommand> value)
   {
   ...
   public JavaPackagesWithPatternsEditor setActiveCommands(Map<String, ModelCommand> value)
   {
   ...
   public JavaPackagesWithPatternsEditor setCommandListeners(Map<String, List<CommandStream>> value)
   {
   ...
   public JavaPackagesWithPatternsEditor setMapOfFrames(Map<String, Object> value)
   {
   ...
   public JavaPackagesWithPatternsEditor setMapOfModelObjects(Map<String, Object> value)
   {
   ...
   public JavaPackagesWithPatternsEditor setMapOfParsedObjects(Map<String, Object> value)
   {
