...
public class JavaDocEditor
{
   ...
   {
      Map<String, Object> map = Yaml.forPackage("javaPackagesToJavaDoc.JavaDoc").decode(yamlString);
...
private List<ModelCommand> haveCommandPrototypes()
   ...
   public JavaDocEditor setCommandPrototypes(List<ModelCommand> value)
   {
